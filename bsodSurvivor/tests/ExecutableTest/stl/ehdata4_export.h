...
namespace Compress
{
    inline static const uint32_t maxRVAs = 4;        // From HandlerMap (dispType, handlerAddr, 2 continuation addresses)
    inline static const uint32_t maxBufferSize = 27; // Maximum size of a single structure, from HandlerType
    inline static const uint32_t compIntSize = 5;    // Maximum compressed integer buffer size
    struct RVAoffsets
    {
        uint32_t count;
